...
<div class="site_content alt_bg_2">
    <div class="layout-978px-centered profile_nav_wrapper">
        <ul class="profile_nav clearfix">
            ...
            <li><span class="current_tab">Followers</span></li>
...
<div class="site_content">
    <div class="section_wrapper layout-978px-centered clearfix">
        <div class="col_8">
            ...
            <h2 class="section_headers">Followers <span class="highlight">(213)</h2>
            <div class="follow_user_row clearfix">
                <div class="col_4 clearfix">
                    <div class="follow_user_pic"><a href="profile.php"><img src="ubd_imgs/userpic.jpg" width="72" height="72" border="0" /></a></div>
                    <div class="follow_user_info">
                        <div>
                            <a href="profile.php">Username</a><br>
                            City, ST
                        </div>
                        <a href="#" class="follow_button">Follow This User</a>
                    </div>
                ...
                <div class="col_4 endcap">
                    <ul class="follow_user_gallery clearfix">
                        <li><a href="design.php"><img src="ubd_imgs/design_list_placeholder.jpg" width="96" height="72" border="0" /></a></li>
                        <li><a href="design.php"><img src="ubd_imgs/design_list_placeholder.jpg" width="96" height="72" border="0" /></a></li>
                        <li class="endcap"><a href="design.php"><img src="ubd_imgs/design_list_placeholder.jpg" width="96" height="72" border="0" /></a></li>
                    </ul>
                </div>
            </div>
            <div class="follow_user_row clearfix">
            ...
            <div class="follow_user_row clearfix">
                <div class="col_4 clearfix">
                    ...
                    <div class="follow_user_info">
                        ...
                        <a href="#" class="unfollow_button">Unfollow This User</a>
                    </div>
                </div>
                <div class="col_4 endcap">
                    <ul class="follow_user_gallery clearfix">
            ...
            <div class="follow_user_row footercap clearfix">
                <div class="col_4 clearfix">
                    <div class="follow_user_pic"><a href="profile.php"><img src="ubd_imgs/userpic.jpg" width="72" height="72" border="0" /></a></div>
                    <div class="follow_user_info">
                        <div>
